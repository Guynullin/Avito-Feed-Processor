...
def get_make_for_spring(card: dict) -> None:
    """sets the manufacturer by matching the string.

    :param card: a spring card.
    :return: None.
    """
...
def parse_spring(products: list):
    """returns a list of the springs cards.

    :param products: a list with data from the app_products table.
    :return: a list of the springs cards or zero when error occured.
    """
    cards = []
    count = 0
